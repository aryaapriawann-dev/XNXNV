export const metadata = { title: 'Artikel 273' }
export default function Article273Page() {
  return (
    <article className="py-16 px-4 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold text-zinc-900 dark:text-white">Artikel #273</h1>
