export const metadata = { title: 'Artikel 147' }
export default function Article147Page() {
  return (
    <article className="py-16 px-4 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold text-zinc-900 dark:text-white">Artikel #147</h1>
