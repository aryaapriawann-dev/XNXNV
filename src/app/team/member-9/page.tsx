export const metadata = { title: 'Team Member 9' }
export default function TeamMember9Page() {
  return (
    <section className="py-16 px-4 max-w-3xl mx-auto">
      ...
      <div className="mt-8 border-t border-zinc-200 dark:border-zinc-800 pt-6 text-zinc-600 dark:text-zinc-400">
        <p>Bio singkat untuk member ke-9. Menghadirkan pengalaman dan keahlian di bidang teknologi digital.</p>
      </div>
    </section>
  );
}
