...
const jobs: Job[] = [
      ...
      },
  {
    ...
    posted: "2024-09-04",
    description: "Kami mencari Data Analyst yang detail-oriented untuk mengekstrak insight dari data dan mendukung keputusan bisnis. Anda akan bekerja dengan SQL, alat visualisasi, dan kerangka pelaporan.",
    requirements: [
      "3+ tahun pengalaman di bidang analisis data",
      "Mahir SQL dan Python",
      "Pengalaman dengan alat visualisasi (Tableau, Power BI)",
      "Keterampilan analitis dan komunikasi yang kuat",
      "Pemahaman metode statistik",
    ],
    benefits: [
      "Asuransi kesehatan",
      "Budget pelatihan data",
      "Jam kerja fleksibel",
      "Retreat tahunan",
